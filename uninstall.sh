...
rm -f /usr/local/share/cfg/cfg.conf.sample
echo "deleted: /usr/local/share/cfg/cfg.conf.sample"

rm -f /usr/local/share/cfg/host.gitignore.sample
echo "deleted: /usr/local/share/cfg/host.gitignore.sample"
